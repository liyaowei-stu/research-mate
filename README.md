...
```bash
curl -fsSL https://raw.githubusercontent.com/liyaowei-stu/research-mate/main/install.sh | bash
```

### Custom binary paths (common on Linux)

```bash
curl -fsSL https://raw.githubusercontent.com/liyaowei-stu/research-mate/main/install.sh | bash -s -- \
...
```bash
git clone https://github.com/liyaowei-stu/research-mate.git ~/.research-mate
...
- Original [ResearchMate](https://github.com/yxbian23/research-mate) by [@yxbian23](https://github.com/yxbian23)
